...
api_key = os.getenv("GROQ_API_KEY", "your-api-key-here")  # Replace with a secure method
...
if uploaded_file:
    resume_text = extract_text_from_pdf(uploaded_file) if uploaded_file.type == "application/pdf" else None
